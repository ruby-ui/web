module Components
  class ComponentPreviewTabs < Components::Base
    def initialize(context:, ruby_code: nil, title: nil, description: nil)
      @title = title
    ...
    def view_template(&)
      ...
      # render ComponentRender.new(context: @context, ruby_code: @ruby_code) { capture(&) }
    end
