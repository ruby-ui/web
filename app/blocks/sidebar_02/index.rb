class Blocks::Sidebar02::Index < Views::Base
  FAVORITES = [
  ...
  CODE = <<~RUBY
    SidebarWrapper do
      render Blocks::Sidebar02::AppSidebar.new
      SidebarInset do
        header(class: "flex h-16 shrink-0 items-center gap-2 border-b px-4") do
          ...
          Breadcrumb do
            BreadcrumbList do
              BreadcrumbItem(class: "hidden md:block") do
                BreadcrumbLink(href: "#") { "Building Your Application" }
              end
